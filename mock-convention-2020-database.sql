...
--
-- Host: localhost    Database: mockConDatabase
-- ------------------------------------------------------
...
CREATE TABLE `precinct` (
  ...
  CONSTRAINT `precinct_ibfk_1` FOREIGN KEY (`countyID`) REFERENCES `county` (`countyid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `state` (
  ...
  CONSTRAINT `state_ibfk_1` FOREIGN KEY (`regionID`) REFERENCES `region` (`regionid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-06 12:49:40
